...
This repository is intended to be read as a governance surface, not as a software manual.
The sequence below is the shortest path through Hydra Core's public operating model.
